...
public class SelectClientBillActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_client_bill);
    ...
    public void toProductSelection(View view) {
        if(client!= null) {
            ...
            Toast.makeText(SelectClientBillActivity.this,
